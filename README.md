...
| 📄 简历分析 | `01-resume-analysis.md` | 多维评估 + STAR 改写 + ATS 自查 |
...
| ⚖️ Offer 对比 | `07-offer-comparison.md` | 对比分析框架，帮你理性选择 |
| 💰 薪资谈判 | `08-salary-negotiation.md` | 分场景话术，不卑不亢谈薪资 |

## ✨ 特色功能

- **简历多维评估** —— 从内容力、成果量化、关键词匹配等角度给出分析，帮你找到改进方向
- **隐藏信号解码** —— "抗压能力"=加班多？"全栈"=团队小？JD 字面背后的真实含义
- **Offer 对比框架** —— 结构化对比表格，帮你理清各个 Offer 的利弊
- **Mock 面试模拟** —— 说一句"模拟面试"，AI 扮演面试官陪你练习
- **追问预演** —— 不只是问问题，还会预判面试官接下来 2-3 轮追问
- **ATS 自查清单** —— 告诉你常见的 ATS 踩坑点，省得简历投了 HR 没看到
